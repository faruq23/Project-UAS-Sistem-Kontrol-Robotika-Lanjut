...
# ==============================================================================
# BAGIAN 1: FUNGSI-FUNGSI INTI (FOKUS PADA BETWEEN-CLASS VARIANCE)
# ==============================================================================
...
def compute_between_class_variance(im, th):
    ...
    # Memisahkan piksel menjadi dua kelas berdasarkan threshold
    kelas0_pixels = im[im < th]
    kelas1_pixels = im[im >= th]
    
    # Menghindari pembagian dengan nol jika salah satu kelas kosong
...
# ==============================================================================
# BAGIAN 3: EKSEKUSI UTAMA DAN VISUALISASI
# ==============================================================================

# --- Setup Gambar ---
try:
    path_im = r'C:\Users\User\Downloads\WhatsApp Image 2025-06-20 at 14.54.44_b60e4050.jpg' # Ganti jika perlu
...
# --- Menjalankan Perhitungan dan Pencarian ---
...
# --- Menampilkan Perbandingan Nilai di Konsol ---
print("\n" + "="*50)
...
# Plot 3: Hasil Segmentasi Algoritma Genetika
...
# Plot 4: Hasil Segmentasi Brute-Force
